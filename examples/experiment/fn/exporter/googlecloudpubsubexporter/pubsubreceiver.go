...
func (receiver *PubSubExporterFn) handleMetric(ctx context.Context, payload []byte, compression compression) (pmetric.Metrics, error) {
...
func (receiver *PubSubExporterFn) init() {
